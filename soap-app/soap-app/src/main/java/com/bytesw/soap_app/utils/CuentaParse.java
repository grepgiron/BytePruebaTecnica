...
public class CuentaParse {
    ...
    public CuentaData parse(String trama) {
        ...
        return new CuentaData(clienteId, fechaApertura, horaApertura, estado, saldo);
    }
    ...
    public static class CuentaData {
        ...
        public CuentaData(Long clienteId, LocalDate fechaApertura, LocalTime horaApertura, String estado, BigDecimal saldo) {
